      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex gap-2 mb-4">
            <span className="bg-blue-100 text-blue-700 text-xs font-medium px-3 py-1 rounded-full">SQL</span>
            <span className="bg-blue-100 text-blue-700 text-xs font-medium px-3 py-1 rounded-full">Power BI</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              UCI Online Retail II dataset from <a href="https://www.kaggle.com/datasets/mashlyn/online-retail-ii-uci" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">Kaggle</a>. 1M+ transactions from a UK-based online gift-ware retailer (2009-2011).
            </p>
