      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-slate-600 mb-4">
              Synthetic dataset sourced from <a href="https://mavenanalytics.io/data-playground/global-electronics-retailer" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline">Maven Analytics</a>. Includes transactional sales, product hierarchy, customer demographics, and store-level data (2017–2021).
            </p>
